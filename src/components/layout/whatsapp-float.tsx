...
export function WhatsAppFloat({ className }: Props) {
  ...
  return (
    <a
      ...
      className={cn(
        "relative fixed z-40 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-semibold text-white transition-colors duration-500 hover:bg-[#1ebe57] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]/50 focus-visible:ring-offset-2",
